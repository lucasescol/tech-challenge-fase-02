...
@Getter
@EqualsAndHashCode(exclude = { "tipoUsuario" })
public class Usuario {
    ...
    private Usuario(Long id, String nome, Email email, String login, String senha, Endereco endereco,
    ...
    public static Usuario criar(Long id, String nome, String email, String login, String senha, Endereco endereco,
            TipoUsuario tipoUsuario) {
        ...
        if (email == null || email.trim().isEmpty()) {
            throw new DomainException("Email do usuário não pode ser vazio");
        }
        ...
        return new Usuario(id, nome.trim(), emailVO, login.trim(), senha, endereco, tipoUsuario);
    }
